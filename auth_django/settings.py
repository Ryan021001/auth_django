...
SECRET_KEY = "django-insecure-bj)2w+f28(ss9je)n3_%h%9(h2+%7qjzrnbc(^fcnbgcf&jxzg"

JWT_TOKEN_EXPIRE_HOURS = config("JWT_TOKEN_EXPIRE_HOURS", cast=int, default=8)
REFRESH_JWT_TOKEN_EXPIRE_HOURS = config(
    "REFRESH_JWT_TOKEN_EXPIRE_HOURS", cast=int, default=40
)
...
DATABASES = {
    "default": {
        ...
        "TEST": {"NAME": config("DATABASE_NAME", cast=str)},
    }
}
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ["common.auth.JWTAuth"],
